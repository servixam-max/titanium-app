...
export const routines: Routine[] = [
  {
    day: 1,
    title: "Día 1: Empuje",
    subtitle: "Pecho, hombros y tríceps. 6 ejercicios, ritmo intenso.",
    type: "strength",
    duration: "30 MIN",
    ...
    exercises: [
      ...
      },
      {
        ...
        description: "Remata el pecho y tríceps con flexiones al fallo. Mantén el cuerpo recto.",
        tempo: "2 - 0 - 2 - 0",
        category: "chest",
        difficulty: "Principiante",
  ...
  },
  {
    day: 2,
    title: "Día 2: Tirón",
    subtitle: "Espalda, bíceps y deltoides posterior. 6 ejercicios, ritmo intenso.",
    type: "strength",
    duration: "30 MIN",
    difficulty: "Intermedio",
    equipment: "MANCUERNAS",
    ...
    exercises: [
      ...
      },
      {
        ...
        restSeconds: 75,
        equipment: "dumbbells",
        description: "Peso muerto a piernas rígidas. Siente el estiramiento en isquiotibiales y glúteos.",
        tempo: "3 - 1 - 2 - 0",
        category: "legs",
        difficulty: "Avanzado",
      ...
      },
      {
        ...
        restSeconds: 60,
        equipment: "dumbbells",
        description: "Tira de las mancuernas hacia el mentón. Codos por encima de las muñecas.",
        tempo: "2 - 1 - 2 - 0",
        category: "shoulders",
        difficulty: "Intermedio",
        image: getImg("upright_row"),
      },
      {
        id: "d2-4",
        name: "Curl Martillo",
