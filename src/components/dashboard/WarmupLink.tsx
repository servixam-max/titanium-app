...
export default function WarmupLink({ exerciseCount }: WarmupLinkProps) {
  return (
    <Link
      ...
      className="group flex h-[52px] items-center gap-3 rounded-2xl border border-white/10 bg-[#0E1422]/90 px-4 shadow-md transition-all hover:border-cyan-400/40 active:scale-[0.98]"
    >
      ...
      <span className="text-[11px] text-slate-300 font-mono font-medium transition-colors group-hover:text-white">
