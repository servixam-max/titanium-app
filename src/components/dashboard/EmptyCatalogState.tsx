...
export default function EmptyCatalogState({ onReset }: EmptyCatalogStateProps) {
  return (
    <div className="mt-4 flex flex-col items-center justify-center gap-2 rounded-3xl bg-white dark:bg-gradient-to-br dark:from-[#141828] dark:via-[#111422] dark:to-[#0D101A] p-8 text-center shadow-sm">
