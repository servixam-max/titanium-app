...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // === v8 Titanium Obsidian & Electric Emerald — core palette ===
      ...
      boxShadow: {
        ...
        neon: "0 4px 16px rgba(0, 245, 155, 0.25)",
        "neon-strong": "0 6px 24px rgba(0, 245, 155, 0.40)",
        "cyan-neon": "0 4px 16px rgba(0, 229, 255, 0.25)",
        glow: "0 0 24px rgba(0, 245, 155, 0.28)",
